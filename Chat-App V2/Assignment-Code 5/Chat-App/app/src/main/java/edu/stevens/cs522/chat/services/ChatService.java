...
public class ChatService extends Service implements IChatService {
    ...
    public void onCreate() {
        ...
        //A looper can handle messages on a background thread so create a new HandlerThread
        //to do that, then use the Looper from that HandlerThread in the SendHandler class
